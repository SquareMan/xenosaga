...
INCLUDE_ASM("asm/nonmatchings/xgl/jpeg_NOPHACK_2", ConvertMCU2YUV);

INCLUDE_ASM("asm/nonmatchings/xgl/jpeg_NOPHACK_2", ConvertYUV2RGB);

INCLUDE_ASM("asm/nonmatchings/xgl/jpeg_NOPHACK_2", StartOfScan);

INCLUDE_ASM("asm/nonmatchings/xgl/jpeg_NOPHACK_2", xglJpegDecode);
