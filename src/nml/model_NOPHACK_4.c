...
INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_4", nmlModelFlushSub);

INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_4", nmlModelConstruct);

INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_4", nmlModelInit);

INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_4", nmlModelClear);
