...
INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_2", nmlModelEntryEffect);

INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_2", nmlModelEntryCard);

INCLUDE_ASM("asm/nonmatchings/nml/model_NOPHACK_2", nmlModelRenderProreal);
