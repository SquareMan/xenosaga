...
def firstDiffMain():
    ...
    BUILTROM = buildFolder / f"SLUS_204.69"
    BUILTMAP = buildFolder / f"SLUS_204.69.map"

    EXPECTEDROM = "expected" / Path("SLUS_204.69")
    EXPECTEDMAP = "expected" / Path("SLUS_204.69.map")
